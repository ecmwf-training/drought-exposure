...
Check out the application [here](https://apps.copernicus-climate.eu/c3s-apps/ecde/)


## Purpose & Development

The development of the ECDE application was driven by the European Environment Agency (EEA) to address information needs regarding climate impact indicators relevant to national climate change adaptation initiatives across the EU. The list of indicators is based on a technical report from the European Topic Centre on Climate Change Impacts, Vulnerability and Adaptation (ETC‑CCA).
...
Catalogue entry (indicator data): https://cds.climate.copernicus.eu/datasets/sis-ecde-climate-indicators?tab=overview
